...
func TestLimiterRedisOutageLocalFallback(t *testing.T) {
	synctest.Test(t, func(t *testing.T) {
		// Use a frozen clock and an immediate Redis command error. Real socket
		// refusal latency can spread these calls over multiple emission intervals,
		// so "at most five instantly" was not an assertion about a single burst.
...
func TestAllowKeyCancelledContextReturnsCtxError(t *testing.T) {
	...
	withRedis.UniversalClient = dead

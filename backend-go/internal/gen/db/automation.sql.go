...
const skipConditionalDelivery = `-- name: SkipConditionalDelivery :execresult
UPDATE delivery_executions
...
func (q *Queries) SkipConditionalDelivery(ctx context.Context, id []byte) (sql.Result, error) {
	return q.db.ExecContext(ctx, skipConditionalDelivery, id)
}

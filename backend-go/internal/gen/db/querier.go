...
type Querier interface {
	...
	BindAITestAttachment(ctx context.Context, arg BindAITestAttachmentParams) (int64, error)
	...
	CompleteAIInvocation(ctx context.Context, arg CompleteAIInvocationParams) (int64, error)
	CountAIConnectionActive(ctx context.Context, connectionID string) (int64, error)
	CountAITestSessions(ctx context.Context, arg CountAITestSessionsParams) (int64, error)
	...
	CreateAIAdminAudit(ctx context.Context, arg CreateAIAdminAuditParams) error
	CreateAIConnection(ctx context.Context, arg CreateAIConnectionParams) error
	CreateAIInvocation(ctx context.Context, arg CreateAIInvocationParams) error
	CreateAIModel(ctx context.Context, arg CreateAIModelParams) error
	CreateAIObjectDeletion(ctx context.Context, arg CreateAIObjectDeletionParams) error
	CreateAITestAttachment(ctx context.Context, arg CreateAITestAttachmentParams) error
	CreateAITestMessage(ctx context.Context, arg CreateAITestMessageParams) error
	CreateAITestSession(ctx context.Context, arg CreateAITestSessionParams) error
	...
	CreateRunResultShare(ctx context.Context, arg CreateRunResultShareParams) error
	...
	DeleteAIConnection(ctx context.Context, id string) (int64, error)
	DeleteAIModel(ctx context.Context, id string) (int64, error)
	DeleteAIObjectDeletion(ctx context.Context, storageKey string) error
	DeleteAITestAttachment(ctx context.Context, arg DeleteAITestAttachmentParams) (int64, error)
	DeleteAITestSession(ctx context.Context, id string) (int64, error)
	DeleteAITestSessionAttachments(ctx context.Context, sessionID string) error
	...
	EnsureAITestOwner(ctx context.Context, ownerID int64) error
	...
	GetAIConnection(ctx context.Context, id string) (AiConnection, error)
	GetAIInvocation(ctx context.Context, id string) (AiInvocation, error)
	GetAIInvocationByRequest(ctx context.Context, arg GetAIInvocationByRequestParams) (AiInvocation, error)
	GetAIModel(ctx context.Context, id string) (AiModel, error)
	GetAIObjectDeletion(ctx context.Context, storageKey string) (AiObjectDeletion, error)
	GetAITestAttachment(ctx context.Context, arg GetAITestAttachmentParams) (AiTestAttachment, error)
	GetAITestSession(ctx context.Context, arg GetAITestSessionParams) (AiTestSession, error)
	GetAITestSessionInternal(ctx context.Context, id string) (AiTestSession, error)
	...
	GetRunResultShare(ctx context.Context, sourceRunID sql.NullString) (GetRunResultShareRow, error)
	...
	LeaseAIObjectDeletion(ctx context.Context, arg LeaseAIObjectDeletionParams) (int64, error)
	ListAIConnections(ctx context.Context) ([]AiConnection, error)
	ListAIInvocations(ctx context.Context, arg ListAIInvocationsParams) ([]AiInvocation, error)
	ListAIModels(ctx context.Context) ([]AiModel, error)
	ListAIObjectDeletions(ctx context.Context, arg ListAIObjectDeletionsParams) ([]AiObjectDeletion, error)
	ListAITestAttachments(ctx context.Context, sessionID string) ([]AiTestAttachment, error)
	ListAITestMessages(ctx context.Context, sessionID string) ([]AiTestMessage, error)
	ListAITestSessions(ctx context.Context, arg ListAITestSessionsParams) ([]AiTestSession, error)
	...
	ListExpiredAITestSessions(ctx context.Context, arg ListExpiredAITestSessionsParams) ([]AiTestSession, error)
	...
	ListStaleAIInvocations(ctx context.Context, updatedAt time.Time) ([]AiInvocation, error)
	...
	LockAIConnection(ctx context.Context, id string) (AiConnection, error)
	LockAIInvocation(ctx context.Context, id string) (AiInvocation, error)
	LockAIModel(ctx context.Context, id string) (AiModel, error)
	LockAIObjectDeletion(ctx context.Context, storageKey string) (AiObjectDeletion, error)
	LockAITestOwner(ctx context.Context, ownerID int64) (int64, error)
	LockAITestSession(ctx context.Context, arg LockAITestSessionParams) (AiTestSession, error)
	LockAITestSessionInternal(ctx context.Context, id string) (AiTestSession, error)
	...
	MarkAITestSessionDeleting(ctx context.Context, arg MarkAITestSessionDeletingParams) (int64, error)
	...
	ReleaseAITestSession(ctx context.Context, arg ReleaseAITestSessionParams) error
	...
	RequestAIInvocationCancellation(ctx context.Context, id string) (int64, error)
	...
	RetryAIObjectDeletion(ctx context.Context, arg RetryAIObjectDeletionParams) (int64, error)
	RetryAITestSessionCleanup(ctx context.Context, arg RetryAITestSessionCleanupParams) (int64, error)
	...
	SetAIConnectionCredential(ctx context.Context, arg SetAIConnectionCredentialParams) (int64, error)
	SetAITestSessionActive(ctx context.Context, arg SetAITestSessionActiveParams) error
	...
	SkipConditionalDelivery(ctx context.Context, id []byte) (sql.Result, error)
	StartAIInvocation(ctx context.Context, arg StartAIInvocationParams) (int64, error)
	...
	UpdateAIConnection(ctx context.Context, arg UpdateAIConnectionParams) (int64, error)
	UpdateAIInvocationOutput(ctx context.Context, arg UpdateAIInvocationOutputParams) (int64, error)
	UpdateAIModel(ctx context.Context, arg UpdateAIModelParams) (int64, error)

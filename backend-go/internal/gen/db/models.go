...
type AccessGroupDepartment struct {
	GroupID         uint64
	DepartmentID    uint64
...
type AccessGroupExternalMember struct {
	GroupID         uint64
...
type DirectorySyncRun struct {
	...
	GroupsCount            uint32
	GroupMembersCount      uint32
	GroupFetchWarnings     uint32
	MemberMappingErrors    uint32
	UnknownUsersCount      uint32
	TargetCode             string
...
type DirectorySyncUserGroupMemberStage struct {
	RunID           uint64
	ExternalGroupID string
	ExternalUserID  string
}

type DirectorySyncUserGroupStage struct {
	RunID           uint64
	ExternalGroupID string
	Name            string
	Description     string
...
type SyncBatch struct {
	...
	TriggerType      string
	Status           string
	RequestedTargets json.RawMessage
	CreatedBy        sql.NullInt64
	CreatedAt        time.Time
	FinishedAt       sql.NullTime
}

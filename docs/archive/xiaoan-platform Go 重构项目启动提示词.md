你现在负责 **xiaoan-platform 后端 Go 重构与后续开发**。
...
docs/开发进度清单.md
docs/xiaoan-platform Go 后端目标架构.md
docs/xiaoan-platform Go 重构执行计划.md
```

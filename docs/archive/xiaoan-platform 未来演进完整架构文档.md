# xiaoan-platform 未来演进完整架构文档

**项目名称：** xiaoan-platform  
...
xiaoan-platform 的用户体验核心不是“进入一个应用中心”。
...
但保持 xiaoan-platform 自己的 Application Workspace 设计。
...
xiaoan-platform 最终应该给用户一种感觉：

> 打开飞书里的 xiaoan-platform，就进入一个统一 AI 工作台。

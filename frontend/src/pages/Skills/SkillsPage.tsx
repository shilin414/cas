...
import { PageHeader, PageSurface } from '@/components/ProductUI';
...
const SkillsPage = () => {
  ...
  return (
    <PageSurface width="max" className="skills-page">
      <PageHeader title="技能管理" description="查看和维护 Codex 与 GraphFlow 使用的文件系统技能。" actions={<div className="skills-header-actions"><Button icon={<ReloadOutlined />} onClick={() => void loadSkills()}>刷新</Button>{canManage && <Button type="primary" icon={<PlusOutlined />} onClick={() => setCreateOpen(true)}>新增技能</Button>}</div>} />

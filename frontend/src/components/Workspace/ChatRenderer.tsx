...
const ChatRenderer: React.FC<Props> = ({ application }) => {
  ...
  // The header action leaves this route. Suppress the in-place tick effect so
  // it cannot race navigation by rewriting the old chat URL.
  ...
  // performs an in-place reset. Layout effect avoids a stale-conversation flash.

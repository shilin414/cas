export type ThemeId = 'light' | 'ink' | 'feishu' | 'dark' | 'midnight' | 'ocean' | 'forest' | 'violet' | 'sage' | 'lavender';
...
export const THEME_PRESETS: readonly ThemePreset[] = [
  ...
  },
  {
    id: 'feishu',
    name: '飞书蓝',
    description: '参考飞书的清爽蓝白协作界面',
    mode: 'light',
    colors: {
      bgVoid: '#F5F6F7', bgSurface: '#F7F8FA', bgCard: '#FFFFFF', bgElevated: '#EFF0F1',
      border: '#DEE0E3', borderLit: '#B7BBC1', text: '#1F2329', textSecondary: '#4E5969',
      textDim: '#646A73', primary: '#2864DC', primaryHover: '#1D4FBF', onPrimary: '#FFFFFF',
      shadowSm: '0 1px 2px rgba(31, 35, 41, 0.05)',
      shadowMd: '0 4px 12px rgba(31, 35, 41, 0.08)',
      shadowLg: '0 12px 28px rgba(31, 35, 41, 0.12)',
    },
  },
  {
    id: 'dark',
...
const SELECTABLE_THEME_IDS: readonly ThemeId[] = ['light', 'ink', 'feishu', 'dark', 'midnight', 'sage', 'lavender'];
